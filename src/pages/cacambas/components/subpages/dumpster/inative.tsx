...
const DumpsterRemove: React.FC = () => {
    ...
    const handleConfirmClick = async (data: any) => {
        cacambasservice.removeDumpster(serie, false)
    ...
    return (
        <main>
            <form>
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center justify-center">
                            <span className="text-white">Confirma a inativação da caçamba?</span>
                        </div>
                ...
                <SelectDumpsterDelete uid={uid.current} setSerie={setSerie} status={true} />
