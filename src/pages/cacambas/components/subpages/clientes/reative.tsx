...
const ClienteReative: React.FC = () => {
    ...
    const handleConfirmClick = async (data: any) => {
        ...
        try {
            await clienteManager.reativarCliente(cliente.id || "")
            setTimeout(() => {
                setIsLoading(false)
            }, 200)
    ...
    return (
        <main>
            <form>
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <div className="flex items-center justify-center">
                            <span className="text-white">Confirma a reativação do cliente?</span>
                        </div>
                ...
                <SelectClientesCacambas onChangeCliente={setCliente} onChangeTipo={setCliente} active={false} />
